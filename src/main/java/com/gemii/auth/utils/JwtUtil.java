...
public class JwtUtil {
     ...
     * @return
     */
    public static String createJWT(String grantType, Long expiresIn, User user) {
    ...
    public static Boolean isVerify(String token, User user) {
        ...
        try {
            ...
            throw new LoginFailedException(ResultCodeConstant.NO_PERMISSION, "token maybe expired.");
        }
